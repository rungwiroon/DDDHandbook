...
## มุมมอง SA: ใช้กฎอธิบาย model

เมื่อได้รายการข้อมูลแล้ว ให้เพิ่มคำถามเรื่อง identity, ผู้เปลี่ยนข้อมูล และช่วงเวลาที่กฎต้องเป็นจริง เพื่อเชื่อม ERD กับพฤติกรรม:

| ข้อมูลที่พบ | คำถามวิเคราะห์ | ผลต่อ model ใน MVP |
|---|---|---|
| Order และรายการอาหาร | ลบ line หลังส่งได้หรือไม่ | BR-02 ต้องตรวจผ่าน `Order` ก่อนเปลี่ยน line |
| ชื่อและราคาสินค้า | เป็นค่าปัจจุบันหรือข้อตกลงตอนเพิ่มรายการ | เก็บ snapshot ใน line; ไม่อ่านราคาปัจจุบันมาแทนย้อนหลัง |
| Order และ ticket | ครัวมีหน้าที่และจังหวะทำงานของตัวเองหรือไม่ | แยก Kitchen ownership และส่ง fact ข้าม boundary |

**คำถามที่ SA ต้องตอบ:** ทุกเส้นใน ERD บอกเพียงความสัมพันธ์ หรือมีเหตุผลทางธุรกิจว่าต้องเปลี่ยนข้อมูลพร้อมกันด้วย? ให้บันทึกเหตุผลก่อนเสนอ aggregate boundary และตรวจร่วมกับทีมพัฒนา.
